                            ...
                            <div class="direct-chat-messages">
                                ...
                                <div class="direct-chat-msg">
                                    ...
                                    <img
                                        ...
                                        src="{{ asset('/admins/assets/img/user1-128x128.jpg') }}"
                                ...
                                <div class="direct-chat-msg end">
                                    ...
                                    <img
                                        class="direct-chat-img"
                                        src="{{ asset('/admins/assets/img/user3-128x128.jpg') }}"
                                        alt="message user image"
                                    />
                                    <!-- /.direct-chat-img -->
                                ...
                                <small class="contacts-list-date float-end"> 2/28/2023 </small>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img
                                                class="contacts-list-img"
                                                src="{{ asset('/admins/assets/img/user7-128x128.jpg') }}"
                                                alt="User Avatar"
                                            />
                                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                                ...
                                <small class="contacts-list-date float-end"> 2/20/2023 </small>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img
                                                class="contacts-list-img"
                                                src="{{ asset('/admins/assets/img/user5-128x128.jpg') }}"
                                                alt="User Avatar"
                                            />
                                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                                ...
                                <small class="contacts-list-date float-end"> 2/10/2023 </small>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img
                                                class="contacts-list-img"
                                                src="{{ asset('/admins/assets/img/user6-128x128.jpg') }}"
                                                alt="User Avatar"
                                            />
                                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                                ...
                                <small class="contacts-list-date float-end"> 1/27/2023 </small>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img
                                                class="contacts-list-img"
                                                src="{{ asset('/admins/assets/img/user8-128x128.jpg') }}"
                                                alt="User Avatar"
                                            />
                                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
